...
// let num2 = Math.floor(num1); (floor: arredonda o numero para baixo)
// let num2 = Math.ceil(num1);  (ceil: arredonda o numero para cima)
// let num2 = Math.round(num1); (round: arredonda o numero para o mais próximo)
